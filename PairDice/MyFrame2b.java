...
class MyFrame2b extends JFrame implements ActionListener{
	...
	private JButton b3=new JButton("sum"); private JTextField t3=new JTextField("0",8);
	private JButton b4=new JButton("EQual"); private JTextField t4=new JTextField("0",8);
	
	private JPanel p1=new JPanel();
	
	private PairDice p=new PairDice(0,0);
	
	public MyFrame2b(String s){
		super(s);
